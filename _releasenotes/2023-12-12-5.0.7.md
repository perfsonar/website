...
-  Updated systemd unit files to more reliably restart pscheduler services when postgresql restarts. This solves an issue where test would all enter "Missed" state when postgresql was restarted.
